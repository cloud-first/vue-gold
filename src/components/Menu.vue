  ...
  <div>
    ...
    <ul>
      ...
      <li>
        <router-link
          :to="{path: '/vue/coins-type/list-coins?',
          query: {'status':'2','areaid':'YXQ16053120274791000015','gname': '地下城与勇士', gameId:'YX16053120241378200001',regionId:'YXQ16053120274791000015',serverId:'YXF16053120325978800016','areaname':'广东区','servername':'广东1区','goodsType':3,'list': JSON.stringify(list)} }"
        >
          广东二区 2状态
        </router-link>
      </li>
...
<script>
  export default{
    ...
    created () {
      this.urlName.status=2,
      this.urlName.areaid=2,
      this.urlName.status=2,
      this.urlName.status=2,
      this.urlName.status=2
