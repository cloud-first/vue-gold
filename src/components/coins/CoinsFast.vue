<template>
  ...
  <div class="coin-msg mt-100 bg-fff pb-30">
    <div class="box4 border-bottom clearfix">
      <div class="fl f28 lh110 color-000"><span class="f32 color-000 mr-20 brl pl-20">店铺发货</span>1元={{unPrice}}万金</div>
